...
namespace structures
{
	...
	public:
		...
		/// <summary> Konstruktor. </summary>
		PriorityQueueTwoLists(size_t bufferSize);
	...
	template<typename T>
	inline PriorityQueueTwoLists<T>::PriorityQueueTwoLists(size_t shortListSize) :
		PriorityQueueTwoLists()
	{
		shortList_->trySetCapacity(shortListSize > 2 ? shortListSize : 2);
	}
