...
namespace structures
{
	...
	{
		DSRoutines::rangeCheckExcept(index, size_, "LinkedList<T>::removeAt : Index out of range linked list!");
		...
		else
		{
			...
			getItemAtIndex(index - 1)->setNext(item->getNext());
		}
		size_--;
	...
	{		
		LinkedListItem<T>* item = first_;
		LinkedListItem<T>* toDelete = nullptr;
	...
	{
		DSRoutines::rangeCheckExcept(index, size_, "LinkedList<T>::getItemAtIndex List index out of range!");
